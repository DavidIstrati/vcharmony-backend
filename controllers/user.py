...
class userControllers():
    ...
    def postUser(self, body: schemas.UserCreate):
        ...
        db_user = models.Users(userId=userId, email=email, firstName=firstName, lastName=lastName, password=hashedPassword, entityType=entityType, institution=institution)
        self.db.add(db_user)
        self.db.commit()
